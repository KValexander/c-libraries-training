...
/* Create texture */ 
extern void create_texture(Textures *textures, char *name, char *src);
extern void create_texture_resize(Textures *textures, char *name, char *src, int w, int h);
...
/* MyTexture */
/* Create MyTexture */ 
extern MyTexture create_my_texture(char *name, char *src); // create texture
extern MyTexture create_my_texture_resize(char *name, char *src, int w, int h); // create texture with resize
